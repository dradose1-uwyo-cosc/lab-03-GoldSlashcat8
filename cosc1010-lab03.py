...
print("Part One------------------------------------------------------------------------")
#We are going to start with the basics. Declare a list of states that contains the elements: Wyoming, Colorado, Montana in that order 
...
print(f"{states_list[1].upper()} is south of {states_list[0].upper()}")
